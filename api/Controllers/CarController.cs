...
public class CarsController : ControllerBase
{
    ...
    private readonly IFileUploadService _fileUploadService; // Inject file upload service

    public CarsController(CarService carService, ILogger<CarsController> logger, IFileUploadService fileUploadService)
    {
        _carService = carService;
        _logger = logger;
        _fileUploadService = fileUploadService; // Initialize file upload service
    }
    ...
    [HttpPost]
    public async Task<ActionResult<Car>> PostCar([FromForm] Car car, [FromForm] IFormFile? imageFile)
    {
    ...
    [HttpPut("{id}")]
    public async Task<ActionResult<Car>> PutCar(int id, [FromForm] Car car, [FromForm] IFormFile? imageFile)
    {
        if (car == null) return BadRequest("Car object is null.");
